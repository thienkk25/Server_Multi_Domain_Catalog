...
export const categoryItemVersionController = {
    ...
    updateVersion: handle(req => categoryItemVersionService.updateVersion(req.params.id, req.user.id, req.role, req.body)),
    deleteVersion: handle(req => categoryItemVersionService.deleteVersion(req.params.id, req.user.id, req.role, req.body)),
    ...
    getHistoryVersion: handle(req => categoryItemVersionService.getHistoryVersion(req.params.id, req.role, req.query)),
};